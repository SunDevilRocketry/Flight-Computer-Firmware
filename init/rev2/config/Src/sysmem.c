 ...
 *
 * @warning Per standards, we cannot perform dynamic memory allocation on the FC.
 *          This function is disabled.
 *
 * @param incr Memory size
 * @return Pointer to allocated memory
 */
__attribute__((warning("Dynamic memory allocation is not permitted.")))
void *_sbrk(ptrdiff_t incr)
{
  ...
  /* Disable this call to prevent dynamic memory allocation. */
