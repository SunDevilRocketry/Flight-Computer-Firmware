...
__attribute__((warning("The \"_getpid\" syscall was linked. Its return will never be valid -- do not use it!")))
int _getpid(void)
{
  return -1;
}

__attribute__((warning("The \"_kill\" syscall was linked. Its return will never be valid -- do not use it!")))
...
__attribute__((warning("The \"_exit\" syscall was linked. Its return will never be valid -- do not use it!")))
void _exit (int status)
{
  /* ignore the warning about the kill syscall */
...
__attribute__((warning("The \"_read\" syscall was linked. Its return will never be valid -- do not use it!")))
...
__attribute__((warning("The \"_write\" syscall was linked. This function is not tested for production use!")))
...
__attribute__((warning("The \"_close\" syscall was linked. Its return will never be valid -- do not use it!")))
int _close(int file)
{
  (void)file;
  return -1;
...
__attribute__((warning("The \"_fstat\" syscall was linked. Its return will never be valid -- do not use it!")))
...
__attribute__((warning("The \"_isatty\" syscall was linked. Its return will never be valid -- do not use it!")))
...
__attribute__((warning("The \"_lseek\" syscall was linked. Its return will never be valid -- do not use it!")))
...
__attribute__((warning("The \"_open\" syscall was linked. Its return will never be valid -- do not use it!")))
...
__attribute__((warning("The \"_wait\" syscall was linked. Its return will never be valid -- do not use it!")))
...
__attribute__((warning("The \"_unlink\" syscall was linked. Its return will never be valid -- do not use it!")))
...
__attribute__((warning("The \"_times\" syscall was linked. Its return will never be valid -- do not use it!")))
...
__attribute__((warning("The \"_stat\" syscall was linked. Its return will never be valid -- do not use it!")))
...
__attribute__((warning("The \"_link\" syscall was linked. Its return will never be valid -- do not use it!")))
...
__attribute__((warning("The \"_fork\" syscall was linked. Its return will never be valid -- do not use it!")))
int _fork(void)
{
  errno = EAGAIN;
  return -1;
...
__attribute__((warning("The \"_execve\" syscall was linked. Its return will never be valid -- do not use it!")))
