...
void HAL_OSPI_MspInit(OSPI_HandleTypeDef* hospi)
{
  ...
  */
    ...
    */
    ...
    GPIO_InitStruct.Pin = FLASH_IO4_Pin|FLASH_IO5_Pin|FLASH_IO6_Pin|FLASH_IO7_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_OSPI_MspDeInit(OSPI_HandleTypeDef* hospi)
{
  if(hospi->Instance==OCTOSPI1)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOE, FLASH_IO4_Pin|FLASH_IO5_Pin|FLASH_IO6_Pin|FLASH_IO7_Pin
                          |FLASH_CE_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = BARO_CSB_Pin|BARO_SCK_Pin|BARO_MISO_Pin|BARO_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, BARO_CSB_Pin|BARO_SCK_Pin|BARO_MISO_Pin|BARO_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI3)
  {
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(LORA_NSS_GPIO_Port, LORA_NSS_Pin);

    HAL_GPIO_DeInit(GPIOC, LORA_SCK_Pin|LORA_MISO_Pin|LORA_MOSI_Pin);
