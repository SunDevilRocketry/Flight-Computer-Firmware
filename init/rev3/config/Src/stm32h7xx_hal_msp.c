...
void HAL_OSPI_MspDeInit(OSPI_HandleTypeDef* hospi)
{
  if(hospi->Instance==OCTOSPI2)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOD, FLASH_IO4_Pin|FLASH_IO5_Pin|FLASH_IO6_Pin|FLASH_IO7_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = IMU_CS_Pin|IMU_SCK_Pin|IMU_MISO_Pin|IMU_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = LORA_SS_Pin|LORA_SCK_Pin|LORA_MISO_Pin|LORA_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(hspi->Instance==SPI4)
  {
    ...
    PE6     ------> SPI4_MOSI
    */
    GPIO_InitStruct.Pin = BARO_SCK_Pin|BARO_CSB_Pin|BARO_MISO_Pin|BARO_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, IMU_CS_Pin|IMU_SCK_Pin|IMU_MISO_Pin|IMU_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, LORA_SS_Pin|LORA_SCK_Pin|LORA_MISO_Pin|LORA_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI4)
  {
    ...
    PE6     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, BARO_SCK_Pin|BARO_CSB_Pin|BARO_MISO_Pin|BARO_MOSI_Pin);
