...
/*------------------------------------------------------------------------------
 Set up test
------------------------------------------------------------------------------*/
char test_msg[TEXT_MESSAGE_LENGTH] = "Test: log message system.";
...
------------------------------------------------------------------------------*/
error_log_info( "Test: log message system." );
...
/*------------------------------------------------------------------------------
 Set up test
------------------------------------------------------------------------------*/
char test_msg[TEXT_MESSAGE_LENGTH] = "Test: warning message system.";
TEXT_MESSAGE return_buffer;
memset( &return_buffer, 0, sizeof( TEXT_MESSAGE ) );
TEST_ASSERT_FALSE( "Precondition: Verify that there's no pending messages.", error_is_pending_info() );
...
/*------------------------------------------------------------------------------
 Adding to buffer: Call FUT
------------------------------------------------------------------------------*/
error_log_warning( "Test: warning message system." );
