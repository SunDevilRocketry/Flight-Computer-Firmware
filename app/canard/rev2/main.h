...
#define DEF_FLASH_BUFFER_SIZE  ( 106  )     /* Default size of flash buffers   */
...
FLASH_STATUS read_imu_offset(HFLASH_BUFFER* pflash_handle, IMU_OFFSET *imu_offset);
FLASH_STATUS read_rp(HFLASH_BUFFER* pflash_handle);
